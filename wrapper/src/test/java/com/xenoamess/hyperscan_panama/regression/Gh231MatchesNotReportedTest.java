package com.xenoamess.hyperscan_panama.regression;
...
// https://github.com/xenoamess/hyperscan_panama-java/issues/231
public class Gh231MatchesNotReportedTest {
    @Test
    @Disabled("Vectorscan 5.4.12 does not match this pattern; upstream issue possible")
