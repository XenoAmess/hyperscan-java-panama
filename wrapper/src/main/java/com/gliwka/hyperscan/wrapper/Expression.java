...
public class Expression {
    ...
    public ValidationResult validate() {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment expressionPtr = arena.allocateFrom(this.expression);
            ...
            if (hsResult != 0) {
                ...
                // hs_free_expr_info is not exported by the native library; there is no documented free function.
                // The struct is small and only used transiently during validation.
