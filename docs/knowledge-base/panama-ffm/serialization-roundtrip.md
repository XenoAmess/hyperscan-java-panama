...
```
com.xenoamess.hyperscan_panama.wrapper.HyperscanException: An invalid parameter has been passed. Is scratch allocated?
    at com.xenoamess.hyperscan_panama.wrapper.HyperscanException.hsErrorToException(HyperscanException.java:32)
    at com.xenoamess.hyperscan_panama.wrapper.Database.load(Database.java:337)
```
...
见 `wrapper/src/main/java/com/xenoamess/hyperscan_panama/wrapper/Database.java`：
...
- `wrapper/src/test/java/com/xenoamess/hyperscan_panama/wrapper/DatabaseTest.java#testSerializationDeserializationRoundtrip` 重新启用后通过。
- `performance/src/test/java/com/xenoamess/hyperscan_panama/performance/WrapperSmokeTest.java#databaseSerializationRoundTrip` 重新启用后通过。
